...
#define SAMPLE900COMPR_BITNUM_OFF		16 /* bit number offset */
#define SAMPLE900COMPR_BITNUM_MAX		12 /* max. bit number */
#define SAMPLE900COMPR_INTERVALSIZ		(1<<SAMPLE900COMPR_BITNUM_MAX)  /* interval size for max. bit number */
...
#define AKAI_DRUMFILE_FTYPE	'd' /* file type */
#define AKAI_DRUMFILE_FNAME	"DRUM INPUTS " /* default drum settings file name */



/* AKAI S1100 or S3000 effects file */
#define AKAI_FXFILE_FTYPE	'x' /* file type */
#define AKAI_FXFILE_FNAME	"EFFECTS FILE" /* default effects file name */
#define AKAI_FXFILE_FSIZE	0x1c90 /* XXX default effects file size */



/* AKAI S1100 or S3000 cue-list file */
#define AKAI_QLFILE_FTYPE	'q' /* file type */
#define AKAI_QLFILE_FNAME	"QL1         " /* default cue-list file name */



/* AKAI S1100 or S3000 take-list (song) file */
#define AKAI_TLFILE_FTYPE	't' /* file type */
...
#define AKAI_MULTI3000_FNAME	"MULTI FILE  " /* default multi file name */
